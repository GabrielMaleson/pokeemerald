const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_TENTACRUEL] = _("PURPLE GUY"),
    ...
    [SPECIES_GYARADOS] = _("PROTEIN PETE"),
    ...
    [SPECIES_GROVYLE] = _("FLEUR"),
    [SPECIES_SCEPTILE] = _("LOGGY"),
    [SPECIES_TORCHIC] = _("TORCHIC"),
    [SPECIES_COMBUSKEN] = _("MAGOLOR"),
    [SPECIES_BLAZIKEN] = _("FERRY"),
    [SPECIES_MUDKIP] = _("BRICK"),
    [SPECIES_MARSHTOMP] = _("MARSHTOMP"),
    [SPECIES_SWAMPERT] = _("IND-E"),
    ...
    [SPECIES_LUDICOLO] = _("PETERSONEIGHBOR"),
    ...
    [SPECIES_WHISCASH] = _("POTENTIAL MAN"),
